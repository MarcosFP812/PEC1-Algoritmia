...
IN: 
    ...
    - intervalo: Un intervalo [p0, p1] donde se buscará el valor de x.
...
class Polinomio:
    ...
    def encontrar_minimo_en_intervalo(self, intervalo, paso=0.01):
        ...
        IN:
            - intervalo: El intervalo [p0, p1] donde se busca el mínimo.
    ...
    def dyv(self, intervalo, k, e, minim=True):
        ...
        IN:
            - intervalo: El intervalo [p0, p1] donde se busca el valor de x.
            - k: El valor objetivo que se desea encontrar.
            - e: La precisión o margen de error permitido.
        ...
        OUT:
            - Una lista de valores de x donde f(x) = k, dentro del intervalo especificado con una precisión dada.
        ACLARACION:
            - Es posible que devuelva 2 valores de x muy próximos cuando solo haya una solución, esto se debe a la estimación de e,
            para evitarlo se puede hacer la media de dichos valores y se obtendrá un valor aproximado.
        """
        solucion = []
